...
public final class PrivateCredentialPermission extends Permission {
    ...
    private void init(String name) {
        ...
        if (tokenizer.hasMoreTokens() == false) {
            MessageFormat form = new MessageFormat ("permission.name.name.syntax.invalid.");
            Object[] source = {name};
            throw new IllegalArgumentException
                (form.format(source) + "Credential.Class.not.followed.by.a.Principal.Class.and.Name");
        }
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (tokenizer.hasMoreTokens() == false) {
                ...
                Object[] source = {name};
                throw new IllegalArgumentException
                        (form.format(source) + "Principal.Class.not.followed.by.a.Principal.Name");
            }
            ...
            if (!principalName.startsWith("\"")) {
                ...
                Object[] source = {name};
                throw new IllegalArgumentException
                        (form.format(source) + "Principal.Name.must.be.surrounded.by.quotes");
            }
            ...
            if (!principalName.endsWith("\"")) {
                ...
                if (!principalName.endsWith("\"")) {
                    ...
                    Object[] source = {name};
                    throw new IllegalArgumentException
                        (form.format(source) +"Principal.Name.missing.end.quote");
                }
            }
            ...
            if (principalClass.equals("*") &&
                !principalName.equals("*")) {
                    throw new IllegalArgumentException ("PrivateCredentialPermission.Principal.Class.can.not.be.a.wildcard.value.if.Principal.Name.is.not.a.wildcard.value");
            }
    ...
    static class CredOwner implements java.io.Serializable {
        ...
        public String toString() {
            MessageFormat form = new MessageFormat ("CredOwner.Principal.Class.class.Principal.Name.name");
